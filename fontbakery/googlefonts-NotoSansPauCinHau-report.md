...
<details><summary><b>[17] NotoSansPauCinHau-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the "name" table: Expected "Noto Sans Pau Cin Hau" but got "Noto Sans PauCinHau". [code: mismatch]
...
* 🔥 **FAIL** OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSansPauCinHau/googlefonts/ttf/NotoSansPauCinHau-Regular.ttf']. [code: missing-os2-fsselection-bit7]
...
* 🔥 **FAIL** head version is "2.00101" while name version string (for platform 3, encoding 1) is "Version 2.000". [code: mismatch]
...
* 🔥 **FAIL** On the 'name' table, the full font name 'Noto Sans Pau Cin Hau Regular' does not begin with the font family name 'Noto Sans PauCinHau' in platformID 3, encodingID 1, languageID 1033(0409), and nameID 1. [code: mismatch-font-names]
...
* 🔥 **FAIL** Space and non-breaking space have differing width: The space glyph named space is 281 font units wide, non-breaking space named (uni00A0) is 260 font units wide, and both should be positive and the same. GlyphsApp has "Sidebearing arithmetic" (https://glyphsapp.com/tutorials/spacing) which allows you to set the non-breaking space width to always equal the space width. [code: different-widths]
